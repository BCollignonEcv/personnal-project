<template>
  <footer>
    <p class="col-10">ECV Digital - Capgemini</p>
    <p class="col-2 alignRight">
      <a href="https://www.linkedin.com/in/baptiste-collignon-1a1977124/" target="_blank">
        <svg class="inlineSVG" fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="24px" height="24px">
          <path
